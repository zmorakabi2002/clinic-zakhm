...
export default function Home() {
  ...
  return (
    <div className="w-full md:pt-[189px] pt-[126px]">
      <div className="md:flex md:flex-row flex flex-col gap-[32px] md:justify-between mb-[32px] md:mx-[61px] mx-[29px] justify-center items-center ">
      ...
      <div className="flex flex-col gap-[20px] mb-[32px] md:mx-[65px] mx-[26px]">
        ...
        <ul className="font-[samim] font-normal md:text-[18px] text-[14px] text-[#414E62] md:leading-[30px] leading-[24px] text-justify list-disc">
