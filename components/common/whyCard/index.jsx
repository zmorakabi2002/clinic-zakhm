...
export default function WhyCard({
  ...
  return (
    <div
      className={` flex flex-col justify-center items-center md:gap-3 gap-2  md:rounded-[37px] rounded-[28px] border border-[#E4E7EC] md:shadow-[0px_0px_12.2px_0px_#00000040] shadow-[0px_0px_5px_0px_#00000040] opacity-100 ${classStyle}`}
    >
      <div>
        <Image
          src={cardData?.url}
